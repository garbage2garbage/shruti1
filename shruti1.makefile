...
PACKAGES     = hardware/base hardware/hal hardware/hal/devices hardware/midi hardware/utils hardware/shruti hardware/shruti/shruti1

EEPROM_DATA = hardware/shruti/data/shruti1_patch_library.hex
