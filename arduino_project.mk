...
#
#       TARGET       = CLItest
#       PACKAGES     = Directories containing code
...
# Local sources
VPATH           = $(PACKAGES)
LOCAL_C_SRCS    = $(notdir $(wildcard $(patsubst %,%/*.c,$(PACKAGES))))
LOCAL_CPP_SRCS  = $(notdir $(wildcard $(patsubst %,%/*.cpp,$(PACKAGES))))
LOCAL_CC_SRCS   = $(notdir $(wildcard $(patsubst %,%/*.cc,$(PACKAGES))))
LOCAL_PDE_SRCS  = $(notdir $(wildcard $(patsubst %,%/*.pde,$(PACKAGES))))
LOCAL_AS_SRCS   = $(notdir $(wildcard $(patsubst %,%/*.as,$(PACKAGES))))
...
AVRDUDE_ARD_OPTS = -c stk500v1 -b 57600 -P $(ARDUINO_PORT)
