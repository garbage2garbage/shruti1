...
#define STR_RES_5 71  // 
#define STR_RES_6 72  // 
#define STR_RES_BLIT 73  // blit
#define STR_RES_SAW 74  // saw
#define STR_RES_SQUARE 75  // square
#define STR_RES_TRIANG 76  // triang
#define STR_RES_CZ 77  // cz
#define STR_RES_FM 78  // fm
#define STR_RES_8BITS 79  // 8bits
#define STR_RES_VOICE 80  // voice
#define STR_RES_TABLE 81  // table
#define STR_RES_SWEEP 82  // sweep
#define STR_RES_1S2 83  // 1+2
#define STR_RES_1_2 84  // 1>2
#define STR_RES_1P2 85  // 1*2
#define STR_RES_LF1 86  // lf1
#define STR_RES_LF2 87  // lf2
#define STR_RES_SEQ 88  // seq
#define STR_RES_ARP 89  // arp
#define STR_RES_WHL 90  // whl
#define STR_RES_BND 91  // bnd
#define STR_RES_AS1 92  // as1
#define STR_RES_AS2 93  // as2
#define STR_RES_CV1 94  // cv1
#define STR_RES_CV2 95  // cv2
#define STR_RES_RND 96  // rnd
#define STR_RES_EN1 97  // en1
#define STR_RES_EN2 98  // en2
#define STR_RES_VEL 99  // vel
#define STR_RES_NOT 100  // not
#define STR_RES_GAT 101  // gat
#define STR_RES_LFO1 102  // lfo1
#define STR_RES_LFO2 103  // lfo2
#define STR_RES_STPSEQ 104  // stpseq
#define STR_RES__ARP 105  //  arp
#define STR_RES_MWHEEL 106  // mwheel
#define STR_RES_BENDER 107  // bender
#define STR_RES_ASSGN1 108  // assgn1
#define STR_RES_ASSGN2 109  // assgn2
#define STR_RES__CV1 110  //  cv1
#define STR_RES__CV2 111  //  cv2
#define STR_RES_RANDOM 112  // random
#define STR_RES_ENV1 113  // env1
#define STR_RES_ENV2 114  // env2
#define STR_RES_VELO 115  // velo
#define STR_RES_NOTE 116  // note
#define STR_RES_GATE 117  // gate
#define STR_RES_CUT 118  // cut
#define STR_RES_VCA 119  // vca
#define STR_RES_PW1 120  // pw1
#define STR_RES_PW2 121  // pw2
#define STR_RES_41 122  // 1
#define STR_RES_42 123  // 2
...
#define STR_RES_51 138  // 1
#define STR_RES_61 139  // 1
#define STR_RES_71 140  // 1
#define STR_RES__1 141  // ?1
#define STR_RES_52 142  // 2
#define STR_RES_62 143  // 2
#define STR_RES_72 144  // 2
#define STR_RES__2 145  // ?2
#define STR_RES_53 146  // 3
#define STR_RES_63 147  // 3
#define STR_RES_73 148  // 3
#define STR_RES__3 149  // ?3
#define STR_RES_54 150  // 4
#define STR_RES_64 151  // 4
#define STR_RES_74 152  // 4
#define STR_RES__4 153  // ?4
#define STR_RES_55 154  // 5
#define STR_RES_65 155  // 5
#define STR_RES_75 156  // 5
#define STR_RES__5 157  // ?5
#define STR_RES_56 158  // 6
#define STR_RES_66 159  // 6
#define STR_RES_76 160  // 6
#define STR_RES__6 161  // ?6
#define STR_RES___MUTABLE 162  // > mutable
#define STR_RES___INSTRUMENTS___ 163  //   instruments  <
#define STR_RES_LOAD_SAVE_PATCH 164  // load/save patch
#define STR_RES_STEP_SEQUENCER 165  // step sequencer
#define STR_RES_LOAD 166  // load
#define STR_RES_EXIT 167  // exit
#define STR_RES_SAVE 168  // save
#define STR_RES_EXTERN 169  // extern
#define STR_RES_EQUAL 170  // equal
#define STR_RES_JUST 171  // just
#define STR_RES_PYTHAG 172  // pythag
#define STR_RES_1_4_EB 173  // 1/4 eb
#define STR_RES_1_4_E 174  // 1/4 e
#define STR_RES_1_4_EA 175  // 1/4 ea
#define STR_RES_KANAKA 176  // kanaka
#define STR_RES_RATNAN 177  // ratnan
#define STR_RES_GANAMU 178  // ganamu
#define STR_RES_VANASP 179  // vanasp
#define STR_RES_MANAVA 180  // manava
#define STR_RES_TANARU 181  // tanaru
#define STR_RES_SENAVA 182  // senava
#define STR_RES_HANUMA 183  // hanuma
#define STR_RES_DHENUK 184  // dhenuk
#define STR_RES_NATAKA 185  // nataka
#define STR_RES_KOKILA 186  // kokila
#define STR_RES_RUPAVA 187  // rupava
#define STR_RES_GAYAKA 188  // gayaka
#define STR_RES_VAKULA 189  // vakula
#define STR_RES_MAYAMA 190  // mayama
#define STR_RES_CHAKRA 191  // chakra
#define STR_RES_SURYAK 192  // suryak
#define STR_RES_HATAKA 193  // hataka
#define STR_RES_JHANKA 194  // jhanka
#define STR_RES_NATABH 195  // natabh
#define STR_RES_KEERAV 196  // keerav
#define STR_RES_KHARAH 197  // kharah
#define STR_RES_GOURIM 198  // gourim
#define STR_RES_VARUNA 199  // varuna
#define STR_RES_MARARA 200  // marara
#define STR_RES_CHARUK 201  // charuk
#define STR_RES_SARASA 202  // sarasa
#define STR_RES_HARIKA 203  // harika
#define STR_RES_DHEERA 204  // dheera
#define STR_RES_NAGANA 205  // nagana
#define STR_RES_YAGAPR 206  // yagapr
#define STR_RES_RAGAVA 207  // ragava
#define STR_RES_GANGEY 208  // gangey
#define STR_RES_VAGADH 209  // vagadh
#define STR_RES_SHULIN 210  // shulin
#define STR_RES_CHALAN 211  // chalan
#define STR_RES_SALAGA 212  // salaga
#define STR_RES_JALARN 213  // jalarn
#define STR_RES_JHALAV 214  // jhalav
#define STR_RES_NAVANE 215  // navane
#define STR_RES_PAVANI 216  // pavani
#define STR_RES_RAGHUP 217  // raghup
#define STR_RES_GAVAMB 218  // gavamb
#define STR_RES_BHAVAP 219  // bhavap
#define STR_RES_SHUBHA 220  // shubha
#define STR_RES_SHADVI 221  // shadvi
#define STR_RES_SUVARN 222  // suvarn
#define STR_RES_DIVYAM 223  // divyam
#define STR_RES_DHAVAL 224  // dhaval
#define STR_RES_NAMANA 225  // namana
#define STR_RES_KAMAVA 226  // kamava
#define STR_RES_RAMAPR 227  // ramapr
#define STR_RES_GAMANA 228  // gamana
#define STR_RES_VISHWA 229  // vishwa
#define STR_RES_SHAMAL 230  // shamal
#define STR_RES_SHANMU 231  // shanmu
#define STR_RES_SIMHEN 232  // simhen
#define STR_RES_HEMAVA 233  // hemava
#define STR_RES_DHARMA 234  // dharma
#define STR_RES_NEETIM 235  // neetim
#define STR_RES_KANTAM 236  // kantam
#define STR_RES_RISHAB 237  // rishab
#define STR_RES_LATANG 238  // latang
#define STR_RES_VACHAS 239  // vachas
#define STR_RES_MECHAK 240  // mechak
#define STR_RES_CHITRA 241  // chitra
#define STR_RES_SUCHAR 242  // suchar
#define STR_RES_JYOTIS 243  // jyotis
#define STR_RES_DHATUV 244  // dhatuv
#define STR_RES_NASIKA 245  // nasika
#define STR_RES_KOSALA 246  // kosala
#define STR_RES_RASIKA 247  // rasika
