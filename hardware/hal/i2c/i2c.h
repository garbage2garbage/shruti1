...
#ifndef HARDWARE_HAL_I2C_I2C_H_
#define HARDWARE_HAL_I2C_I2C_H_
...
class I2cMaster {
 public:
  ...
  static void Init() {
    DigitalInput<18>::EnablePullUpResistor();
    DigitalInput<19>::EnablePullUpResistor();
